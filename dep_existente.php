...
<body>
    ...
    <div class="box-one">
      <center>
        <main>
          <h1 id="tituloArea">Adicionar Perfil de Dependente já cadastrado</h1>

          <form action="dep_existente_scripting.php" method="POST">

            <h5>Por favor preencha os campos com as mesmas informações fornecidas quando o usuário foi cadastrado</h5><br>
            
            <div id="espacoForm">
              <label for="nomeDependente">Confirme o nome do dependente:</label>
              <input type="text" id="nomeDependente" name="nomeDependente" required>
            </div>

            <div id="espacoForm">
              <label for="loginDependente">Confirme o login do dependente:</label>
              <input type="text" id="loginDependente" name="loginDependente" required>
            </div>

            <div id="espacoForm">
              <label>Confirme o email do dependente:</label>
              <input type="email" name="emailDependente" required>
            </div>
