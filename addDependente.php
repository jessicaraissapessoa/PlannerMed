        ...
        <div class="conteudo">
          ...
          <div class="actions">
            ...
            <form action="" method="POST">
              <button type="submit" name="cadastrarPerfil" class="meu-botao">
                <div class="conteudo-botao">
                  <img src="img/icon-button-criar-dependente.svg">
                  <span>Criar dependente</span>
                </div>
              </button>
            </form>

            <form action="" method="POST">
              <button type="submit" name="addPerfil" class="meu-botao">
                <div class="conteudo-botao">
                  <img src="img/icon-button-vincular-selecionar-dependente.svg">
                  <span>Vincular Dependente</span>
                </div>
              </button>
            </form>
          </div>
